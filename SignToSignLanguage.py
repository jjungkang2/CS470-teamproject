...
# CONSTANTS     
SIGN_PATH = "C:\\Users\\고준원\\Downloads\\SignToSignLang" ## Your local work folder
...
def download_word_sign(word):
    ...
    browser = webdriver.Chrome(SIGN_PATH + "\\chromedriver.exe") ## Downloaded Chrome driver AT YOUR WORK FOLDER
...
def merge_signs(words):
    ...
    # copyfile(src, dst)
    shutil.copyfile(SIGN_PATH + "\\output.mp4", SIGN_PATH + "\\out.mp4")
